...
$bar_extract=0; # Need to extract barcode or not before demultiplex? Yes: 1; No: 0. If you only have two fastq files, yes you need to do it.
...
$map_rc=1; # Is barcode in fastq and barcode in mapping file reverse completentary? Yes: 1; No: 0. If you only have two fastq files, make it 0.
...
$depth="auto"; # Resampling depth for OTU table. Make it 'auto' if you want as many OTUs and sample as possible.
